...
export class Library {
    ...
    async render() {
        ...
        navBar.innerHTML = ` <h1 class="title-container nav-bar-item" id="title"> Trench Books </h1>
            ...
            <button class="filter-button" id="byTrench">By Trench</button>
            <button class="filter-button" id="byAuthor">By Author</button>
            <button class="filter-button" id="byYear">By Year</button>`;
